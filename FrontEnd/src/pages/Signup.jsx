        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="mb-8 text-center">
            <div className="flex flex-col items-center gap-2 group">
              <div className="size-12 rounded-xl bg-black flex items-center justify-center group-hover:bg-primary/20 transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  className="flex items-center pr-3 inset-y-0 right-0 absolute"
          ...
          <div className="text-center">
            <p className="text-white">
              ...
              <Link to="/login" className="link font-medium link-primary">
                 Sign in
              </Link>
            </p>
          </div>
